...
#from count4_nmos_lcc import count4_nmos



class count16_nmos( gate.module ) :
    def __init__ ( self, name, mapping, parent=None ) :
        ...
        self.gatelist = [ 
            count4_nmos("count4_nmos_0_u", dict( [('Q0', self.port['Q0'].netconn), 
            ...
            count4_nmos("count4_nmos_1_u", dict( [('Q0', self.port['Q4'].netconn), 
            ...
            count4_nmos("count4_nmos_2_u", dict( [('Q0', self.port['Q8'].netconn), 
            ...
            count4_nmos("count4_nmos_3_u", dict( [('Q0', self.port['Q12'].netconn), 
