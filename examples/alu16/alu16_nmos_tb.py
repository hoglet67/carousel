...
from count16_nmos import count16_nmos
#from adder16 import adder16
from sn74181alu_nmos import sn74181alu_nmos
...
class alu16_tb(testbench):
    ...
    def __init__(self, options):
        ...
        dut0 = count16_nmos( "cout16_0_u", dict([ ('Q0', self.netlist['q00']),
                             ('Q1', self.netlist['q01']),
                             ('Q2', self.netlist['q02']),
                             ('Q3', self.netlist['q03']),
                             ('Q4', self.netlist['q04']),
        ...
        dut1 = count16_nmos( "cout16_1_u", dict([ ('Q0', self.netlist['qq00']),
                             ...
                             ('RSTB', self.netlist['rstb'])]))
        dut2 = sn74181alu_nmos( "alu_0_u", dict([ ('A0', self.netlist['q00']),
                                      ('A1', self.netlist['q01']),
                                      ('A2', self.netlist['q02']),
                                      ('A3', self.netlist['q03']),
        ...
        dut3 = sn74181alu_nmos( "alu_1_u", dict([ ('A0', self.netlist['q04']),
                                      ('A1', self.netlist['q05']),
                                      ('A2', self.netlist['q06']),
                                      ('A3', self.netlist['q07']),
        ...
        dut4 = sn74181alu_nmos( "alu_2_u", dict([ ('A0', self.netlist['q08']),
                                      ('A1', self.netlist['q09']),
                                      ('A2', self.netlist['q10']),
                                      ('A3', self.netlist['q11']),
        ...
        dut5 = sn74181alu_nmos( "alu_3_u", dict([ ('A0', self.netlist['q12']),
                                      ('A1', self.netlist['q13']),
                                      ('A2', self.netlist['q14']),
                                      ('A3', self.netlist['q15']),
