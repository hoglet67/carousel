...
class v6502_system_tb(testbench):
    ...
    def __init__(self, options):
        ...
        self.netlist.update( gate.wire([ 'rstb_w', 'rnw_w', 'sync_w', 'sob_w', 'phi0_w', 'phi1_w', 'phi2_w', 'rdy_w', 'nmib_w', 'irqb_w', 'not_addr15_w']))
        ...
        self.gatelist.append( OR( "or_0_u", [self.netlist['web_w'], self.netlist['rnw_w'], self.netlist['phi1_w']]))
